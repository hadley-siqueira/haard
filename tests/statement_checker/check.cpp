// Compiles one project and prints what the statement pass reported, so that
// the golden is the diagnostics and nothing else.
//
...
// file compilation, which is all of them here: a statement is checked against
// the types around it, and a type that came from an import is the TypeTable's
